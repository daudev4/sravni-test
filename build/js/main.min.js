...
/* harmony import */ var _modules_init_blur__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-blur */ "./js/modules/init-blur.js");
/* harmony import */ var _modules_init_question__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-question */ "./js/modules/init-question.js");
...
Object(_modules_init_blur__WEBPACK_IMPORTED_MODULE_2__["initBlur"])();
Object(_modules_init_question__WEBPACK_IMPORTED_MODULE_3__["initQuestion"])();
...
/*!*********************************!*\
  !*** ./js/modules/init-blur.js ***!
  \*********************************/
/*! exports provided: initBlur */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBlur", function() { return initBlur; });
var blurClickSelectors = ['a[href]', 'button'];

var initBlur = function initBlur() {
...
/*!*************************************!*\
  !*** ./js/modules/init-question.js ***!
  \*************************************/
/*! exports provided: initQuestion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initQuestion", function() { return initQuestion; });
var initQuestion = function initQuestion() {
  var questionBlock = document.querySelector('.quiz__question');
  var nextButton = questionBlock.querySelector('.quiz__next-button');
  var answerRadios = questionBlock.querySelectorAll('.quiz__answer-item input[type="radio"]');
  ...
  if (answerRadios.length) {
    answerRadios.forEach(function (item) {
      if (item.checked) {
      ...
      item.addEventListener('change', function () {
        nextButton.classList.remove('button--disabled');
        nextButton.href = "/".concat(item.value, "/");
      });
    });
  }
};
